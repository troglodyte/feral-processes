# Changelog: 0.3.4 and earlier

Release notes for [feral-processes](README.md), `0.3.4` back to the beginning. Entries below `0.2.0` predate
versioning and are kept as written, newest first, separated by a rule. The versioning
policy is at the top of [CHANGELOG.md](CHANGELOG.md). Newer releases are in [CHANGELOG-0.4-to-0.12.md](CHANGELOG-0.4-to-0.12.md).

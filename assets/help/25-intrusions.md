...
An intrusion is a fight. You start one by walking into a hostile program, and everything standing
within a few tiles of the one you bumped comes with it — a pack spawns scattered and gathers when
any one of it is touched.

Five keys run the whole screen.

- a — attack, then pick which group by the letter beside it on screen
- d — defend: 20 points of mitigation for the round, and it deliberately draws more fire
- s — call a routine
- u — use something out of your pack
- j — jack out

...
impl App {
    ...
    pub fn new(
        ...
        Self {
            ...
            pending_dispatch_site: None,
            dispatch_squad: Vec::new(),
            pending_dispatch_destination: None,
            route_cargo_amounts: Vec::new(),
            route_standing: false,
            basket_room: None,
            transfer_source: TransferSource::Base,
            pending_craft: None,
            ...
            sprite_dir_installed: false,
            sprite_library: HashMap::new(),
            sprite_disabled: HashMap::new(),

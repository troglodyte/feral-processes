...
I = [
 ...
 ("kinetic_edge",        "Kinetic Edge",               7, "",         "Weapon", "atk+2 acc+2",                 "7 core_fragment",                                   "",            "sub_process 10%;glitch 8%",       0, 0),
 ...
 ("overclock_core",      "Overclock Core",            22, "",         "Weapon", "atk+3 acc+2",                 "",                                                  "",            "construct 30%;scrapper 15%;trojan 20%", 0, 0),
 ...
 ("recursion_blade",     "Recursion Blade",           14, "",         "Weapon", "atk+2 def+1 acc+2",           "14 core_fragment",                                  "fabricator",  "trojan 10%;proxy 7%",             0, 0),
 ...
 ("static_mesh",         "Static Mesh",               14, "",         "Armor",  "def+2 decompiler+1 eva+5",    "2 bytecode_block+1 charge_coil+1 logic_wafer",      "armory",      "crawler 8%;worm 7%",              0.08, 0),

...
**Status:** approved 2026-08-13, not implemented. (This header is written at
approval time and is not maintained — see `docs/superpowers/INDEX.md`. Answer
implementation questions from `CHANGELOG.md` and a grep.)
